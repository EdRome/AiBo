...
from ...analytics.modeling.elasticity import Elasticity
from ...analytics.modeling.forecasting import ForecastDemand
from ...analytics.modeling.optimizing import OptimizeInventory

from ...analytics.reporting.forecast_plot import forecast_plot
from ...analytics.exploratory.empty_values import find_empty_values, fill_empty_values
from ...analytics.exploratory.slicing import slice_df

from ...transformations.feature_engineering.product_group import create_product_group
...
from ...utils.change_step import return_step_home, change_step_home
...
def optimize_inventory_page():
    ...
    if st.session_state["analysis_complete"] and st.session_state["forecast"] is not None:
        if len(st.session_state["unique_items"]) > 10:
        ...
        st.button("See product mix optimization", key="product_mix_optimization_button", type="primary", on_click=change_step_home)
