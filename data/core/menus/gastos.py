...
class Gasto(BaseModel):
    ...
    step: str = Field(default="waiting_expense")
    ...
    borrar_gasto: bool = Field(default=False)
    procesar_gasto: bool = Field(default=False)

    id_ultimo_gasto: int|List[int] = Field(default=0)
