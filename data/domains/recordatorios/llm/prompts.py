REMAINDER_EXTRACTOR_PROMPT = """Actúa como un extractor de datos precisos. El usuario enviará una lista de tareas o una sola. Tu objetivo es identificar CADA evento por separado.
...
QUERY_REMAINDERS_PROMPT = """Analiza el mensaje del usuario y genera un JSON, sin texto adicional

Instrucciones:
- Si el usuario busca a una persona o acción (ej. "con Maria"), extrae ese string en 'search_query'.
- Si el usuario no menciona una descripción, deja 'search_query' como null
