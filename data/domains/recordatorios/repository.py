...
from core.services.google import leer_eventos
...
def get_remainder_by_criteria(user_id: str, start_date=None, end_date=None, search_query=None, db_session=None):
    ...
    try:
        ...
        lista_formateada = get_google_events(user_id, lista_formateada, start_date, end_date, search_query, db_session)
        # Remueve duplicidades
        lista_formateada = list(set(lista_formateada))
